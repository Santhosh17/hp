// Script for Estimate Create -> Estimate Type : Sheet Fed Digital -> Product type : Single Item -> Paper Stock : Price For Whole Pack -> Digital Press: Click Charge Lookup -> Double Side Black & White
...
public class Estimate_Create_SFD_SingleItem_DP_CCL_DoubleSideBW extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_CCL_DoubleSideBW()
	{
		try
		{
