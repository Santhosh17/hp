...
// Digital Press: Speed Weight Lookup -> Single Side Color -> Inventory GSM Greater Than GSM2 and Less Than GSM3
...
public class Estimate_Create_SFD_SingleItem_DP_SWL_InvGSMGreaterThanGSM2_LessThanGSM3_SingleSideColour extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_SWL_InvGSMGreaterThanGSM2_LessThanGSM3_SingleSideColour()
	{
		try
		{
		...
		String sheetName = "SFD - SWL - InvGSM<GSM3 - SSC";
