...
//-> Digital Press: Click Charge Zone Lookup -> Double Side : Side 1 Black & White Side 2 Color
...
public class Estimate_Create_SFD_SingleItem_DP_CCZL_DoubleSide1BWSide2Color extends SuperTestNG
{
	@Test
	public void testEstimate_Create_SFD_SingleItem_DP_CCZL_DoubleSide1BWSide2Color()
	{
		try
		{
		...
		String sheetName = "CCZL - BW-Color";
