...
public class DigitalPressDelete_ClickChargeLookup extends SuperTestNG
{
  @Test 
  public void testDigitalPressDelete_ClickChargeLookup() 
  {
...
//	  EprintSpecificLinks.SuccessMsgVerification("Digital Press deleted successfully", "ctl00_ContentPlaceHolder1_ctl01_lblMessage");
	  EprintSpecificLinks.DeleteByCheckbox(xlpath, sheetName, 4, 2, 4, 7, "//tbody[1]/tr[1]/td[2]/div[1]/a[1]/span[1]", "ctl00_ContentPlaceHolder1_RadGrid1_ctl00_ctl04_Id", "img_actionsShow", "ctl00_ContentPlaceHolder1_btnDelete");
	  EprintSpecificLinks.SuccessMsgVerification("Digital Press deleted successfully", "ctl00_ContentPlaceHolder1_ctl01_lblMessage");
  }
}