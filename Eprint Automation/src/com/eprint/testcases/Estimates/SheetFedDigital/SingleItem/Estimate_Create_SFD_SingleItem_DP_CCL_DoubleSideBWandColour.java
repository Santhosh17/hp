...
-> Digital Press: Click Charge Lookup -> Double Side Side 1 - Black & White  & Side 2 - Colour*/
...
public class Estimate_Create_SFD_SingleItem_DP_CCL_DoubleSideBWandColour extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_CCL_DoubleSideBWandColour()
	{
		try
		{
		...
		String sheetName = "Double Side B-W colour";
