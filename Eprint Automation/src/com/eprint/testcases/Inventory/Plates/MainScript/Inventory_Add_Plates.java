package com.eprint.testcases.Inventory.Plates.MainScript;
...
public class Inventory_Add_Plates extends SuperTestNG
{
	@Test
	public void testInventory_Add_Plates()
	{
		try
		{
		...
		String sheetName = "Inventory Plates";
