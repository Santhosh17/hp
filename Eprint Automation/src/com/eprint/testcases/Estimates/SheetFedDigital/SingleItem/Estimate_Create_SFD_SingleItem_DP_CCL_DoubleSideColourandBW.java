...
-> Digital Press: Click Charge Lookup -> Double Side Side 1 - Colour  & Side 2 - Black $ White*/
...
public class Estimate_Create_SFD_SingleItem_DP_CCL_DoubleSideColourandBW extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_CCL_DoubleSideColourandBW()
	{
		try
		{
		...
		String sheetName = "Double Side colour B-W";
