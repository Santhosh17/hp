// Script for Estimate Create -> Estimate Type : Sheet Fed Digital -> Product type : Single Item -> Paper Stock : Price For Whole Pack -> Digital Press: Click Charge Lookup -> Single Side Black & White
...
public class Estimate_Create_SFD_SingleItem_DP_CCL_SingleSideBW extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_CCL_SingleSideBW()
	{
			try
			{
			...
			String sheetName = "Single Side Black & White ";
