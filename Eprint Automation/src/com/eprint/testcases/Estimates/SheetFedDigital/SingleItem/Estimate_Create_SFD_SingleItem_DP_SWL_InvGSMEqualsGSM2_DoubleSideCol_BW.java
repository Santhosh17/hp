...
// Digital Press: Speed Weight Lookup -> Double Side1 Colour Side 2 Black & White  -> Inventory GSM Equals to GSM2
...
public class Estimate_Create_SFD_SingleItem_DP_SWL_InvGSMEqualsGSM2_DoubleSideCol_BW extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_SWL_InvGSMEqualsGSM2_DoubleSideCol_BW()
	{
		try
		{
		...
		String sheetName = "SFD - SWL - InvGSM=GSM2 - DSCBW";
