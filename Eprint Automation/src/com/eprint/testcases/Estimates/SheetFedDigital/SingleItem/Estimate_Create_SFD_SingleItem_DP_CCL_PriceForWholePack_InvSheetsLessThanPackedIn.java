// Script for Estimate Create -> Estimate Type : Sheet Fed Digital -> Product type : Single Item -> Paper Stock : Price For Whole Pack -> Inventory Sheets Less than Packed In Value
...
public class Estimate_Create_SFD_SingleItem_DP_CCL_PriceForWholePack_InvSheetsLessThanPackedIn extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_CCL_PriceForWholePack_InvSheetsLessThanPackedIn()
	{
		try
		{
