package com.eprint.testcases.Estimates.SheetFedDigital.Pads;
...
import com.eprint.pageObjects.Estimates.SheetFedDigital.Estimate_Add_SFD_Pads;

public class Estimate_Create_SFD_Pads extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_Pads()
	{
		try
		{
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------//
		...
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 29, 1, "Item Title", Estimate_Add_SFD_Pads.txtbx_ItemTitle());
		
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 30, 2, "Pad Quantity 1", Estimate_Add_SFD_Pads.txtbx_PadQty1());
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 30, 4, "Pad Quantity 2", Estimate_Add_SFD_Pads.txtbx_PadQty2());
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 31, 2, "Pad Quantity 3", Estimate_Add_SFD_Pads.txtbx_PadQty3());
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 31, 4, "Pad Quantity 4", Estimate_Add_SFD_Pads.txtbx_PadQty4());
		
		ProjectLibrary.SingleSelectDropDownbyVisibleText(xlpath, sheetName, 32, 1, "Assigned Press", Estimate_Add_SFD_Pads.drpdn_AssignedPress());
		
		String Paperstock = Generic.getXlCellValue(xlpath, sheetName, 33, 1);
		EprintSpecificLinks.Radwindow("Paper/Stock", Estimate_Add_SFD_Pads.btn_PaperStock(), "//table/tbody/tr[2]/td[2]/iframe", "//div/div[2]/table/tbody/tr/td[2]/div/a[text()='"+Paperstock+"']");
		...
		{
			WebElement PriceForWholePack = Estimate_Add_SFD_Pads.chkbx_PriceForWholePack();
		...
		{
			WebElement PaperStockSupplied = Estimate_Add_SFD_Pads.chkbx_PaperStockSupplied();
		...
		Reporter.log("----------------------------------------------------------------------------------",true);
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
		String EstimateNumber = Estimate_Add_SFD_Pads.Estimate_Summary.txt_EstimateNumber().getText();
		Reporter.log("Estimate Number = "+EstimateNumber,true);
		Reporter.log("----------------------------------------------------------------------------------",true);

		ProjectLibrary.CompareStringText(xlpath, sheetName, 29, 1, "Item Title", Estimate_Add_SFD_Pads.Estimate_Summary.txt_ItemTitle());
		
		ProjectLibrary.CompareStringText(xlpath, sheetName, 30, 2, "Finished Quantity -1", Estimate_Add_SFD_Pads.Estimate_Summary.txt_FinishedQty1());
		ProjectLibrary.CompareStringText(xlpath, sheetName, 30, 4, "Finished Quantity -2", Estimate_Add_SFD_Pads.Estimate_Summary.txt_FinishedQty2());
