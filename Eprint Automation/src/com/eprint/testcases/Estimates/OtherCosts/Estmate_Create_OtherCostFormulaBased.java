...
public class Estmate_Create_OtherCostFormulaBased extends SuperTestNG
{
	@Test
	public static void testEstmate_Create_OtherCostFormulaBased()
	{
		try
		{
		...
		String sheetName = "Formula Based";
		try
		{
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------//
		...
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 32, 1, "Description", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_Description());
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 33, 1, "Cost Formula", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_CostFormula());
		
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 34, 1, "Quantity With Actuals 1", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_QtyWithActuals1());
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 34, 2, "Quantity With Actuals 2", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_QtyWithActuals2());
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 34, 3, "Quantity With Actuals 3", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_QtyWithActuals3());
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 34, 4, "Quantity With Actuals 4", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_QtyWithActuals4());
		
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 35, 1, "Cost 1", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_Cost1());
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 35, 2, "Cost 2", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_Cost2());
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 35, 3, "Cost 3", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_Cost3());
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 35, 4, "Cost 4", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_Cost4());

		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 36, 1, "Markup 1", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_Markup1());
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 36, 2, "Markup 2", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_Markup2());
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 36, 3, "Markup 3", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_Markup3());
		ProjectLibrary.StringDDTextBox(xlpath, sheetName, 36, 4, "Markup 4", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_Markup4());
		
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 37, 1, "Selling Price 1", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_SellingPrice1());
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 37, 2, "Selling Price 2", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_SellingPrice2());
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 37, 3, "Selling Price 3", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_SellingPrice3());
		ProjectLibrary.CompareStringTextBox(xlpath, sheetName, 37, 4, "Selling Price 4", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.txtbx_SellingPrice4());

		ProjectLibrary.ClickOnButton("Save", Estimate_Add_OC_Add.OtherCostRadwindow.FormulaBased.btn_Save());
