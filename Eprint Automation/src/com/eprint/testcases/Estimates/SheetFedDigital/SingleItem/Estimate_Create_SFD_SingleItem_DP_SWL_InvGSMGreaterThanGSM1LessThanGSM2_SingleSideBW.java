...
// Digital Press: Speed Weight Lookup -> Single Side Black & White -> Inventory GSM Greater Than GSM1 Less Than GSM2
...
public class Estimate_Create_SFD_SingleItem_DP_SWL_InvGSMGreaterThanGSM1LessThanGSM2_SingleSideBW extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_SWL_InvGSMGreaterThanGSM1LessThanGSM2_SingleSideBW()
	{
		try
		{
		...
		String sheetName = "SFD - SWL - InvGSM<GSM2 - SSBW";
