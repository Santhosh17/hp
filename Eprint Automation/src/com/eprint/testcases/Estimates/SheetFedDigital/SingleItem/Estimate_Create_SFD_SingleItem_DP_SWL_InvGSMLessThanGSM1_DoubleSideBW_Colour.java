...
// Digital Press: Speed Weight Lookup -> Double Side1 Black & White Side 2 Colour -> Inventory GSM Less Than GSM1
...
public class Estimate_Create_SFD_SingleItem_DP_SWL_InvGSMLessThanGSM1_DoubleSideBW_Colour extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_SWL_InvGSMLessThanGSM1_DoubleSideBW_Colour()
	{
		try
		{
		...
		String sheetName = "SFD - SWL - InvGSM<GSM1 - DSBWC";
