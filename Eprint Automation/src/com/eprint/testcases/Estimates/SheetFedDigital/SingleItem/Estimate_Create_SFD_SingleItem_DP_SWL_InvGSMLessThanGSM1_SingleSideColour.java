...
// Digital Press: Speed Weight Lookup -> Single Side Color -> Inventory GSM Less Than GSM1
...
public class Estimate_Create_SFD_SingleItem_DP_SWL_InvGSMLessThanGSM1_SingleSideColour extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_SWL_InvGSMLessThanGSM1_SingleSideColour()
	{
		try
		{
		...
		String sheetName = "SFD - SWL - InvGSM<GSM1 -SSC";
