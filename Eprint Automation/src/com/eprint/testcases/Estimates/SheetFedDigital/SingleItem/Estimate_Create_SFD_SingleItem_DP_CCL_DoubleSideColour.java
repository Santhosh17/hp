...
import com.eprint.pageObjects.Estimates.SheetFedDigital.Estimate_Add_SFD_Single.Estimate_Summary;

public class Estimate_Create_SFD_SingleItem_DP_CCL_DoubleSideColour extends SuperTestNG
{
	@Test
	public static void testEstimate_Create_SFD_SingleItem_DP_CCL_DoubleSideColour()
	{
		try
		{
		...
		String sheetName = "Double Side Colour";
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------//
		...
		Reporter.log("----------------------------------------------------------------------------------",true);
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
		String EstimateNumber = Estimate_Summary.txt_Estimate_Number().getText();
		...
		//ProjectLibrary.ClickOnButton("Save", Estimate_Summary.btn_Save());
	}
}
