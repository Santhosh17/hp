package com.eprint.pageObjects.CRM.Supplier;
...
{ 
	...
	public static WebElement chkbx_Carrier()
	{
		WebElement element = driver.findElement(By.id("ctl00_ContentPlaceHolder1_ClientAddID_chkcarrier"));
		return element;
	}
	...
	public static WebElement txtbx_AC_Opened()
	{
	...
	{
		WebElement element = driver.findElement(By.id("ctl00_ContentPlaceHolder1_ClientAddID_txt_taxnumber"));
		return element;
	}
	public static WebElement txtbx_Balance()
	{
		WebElement element = driver.findElement(By.id("ctl00_ContentPlaceHolder1_ClientAddID_txt_balance"));
		return element;
	}
